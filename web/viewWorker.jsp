                                    ...
                                    <div class="row">
                                        <form method="POST" action='changeToSelected'>
                                            <div class="form-group">
                                                ...
                                                <button type='submit' onclick="" class="btn btn-default  col-md-1">Submit</button>
                                                <button type='button' onclick="referCase();" data-title="Case Referral" class="btn btn-default col-md-offset-1 col-md-1" id="refer_case_btn">Refer Case</button>
...
%>
            ...
            $(document).on("click", ".pop_up_open", function() {
                ...
                if (div_action_val === 'viewedit' || div_class === 'benefection') {
                    $("#pop_up_content").load('include/' + url + '?workerFin=<%=workerFin%>&jobkey=<%=latestJob.getJobKey()%>&probkey=<%=latestProblem.getProbKey()%>' + "&action=" + div_action_val).dialog({modal: true,
                        minWidth: $(window).width() - 750, resizable: false, title: div_title, draggable: false, close: function() {
                            $(this).dialog('destroy');
                            $('#pop_up_content').empty();
                        }
